...
public class UpImger {
    ...
    public void upimgs(JSONObject jb, Activity a, BaseWebView w) {
        ...
        try {
           ...
           // Log.e("111111111", "upimgs: "+jb.getString("url"));
            if(remain > 0) {
                ...
                Toast.makeText(ma, "The current picture has reached its maximum",Toast.LENGTH_SHORT).show();
            }
        ...
        uploadEvent = new UploadEvent() {
            ...
            public void finished(ArrayList<String> list) {
                ...
                if(list.size()>0) {
                    ...
                    Toast.makeText(ma, "Upload pictures completed",Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ma, "Upload pictures failed",Toast.LENGTH_SHORT).show();
                }
